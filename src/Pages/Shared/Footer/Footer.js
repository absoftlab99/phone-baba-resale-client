...
const Footer = () => {
  ...
  <div className="grid grid-flow-col gap-4">
    ...
    <Link className="link link-hover" to='/products/category/allProducts'>Products</Link> 
    <Link className="link link-hover" to='/register'>Register</Link> 
    <Link className="link link-hover" to='/blogs'>Blog</Link>
  </div> 
  <div>
    <div className="grid grid-flow-col gap-4">
  ...
  <div>
    <p>Copyright © 2022 - All right reserved by Mobile Baba Ltd</p>
  </div>
</footer>
  );
};
